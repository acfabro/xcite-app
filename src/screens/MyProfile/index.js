  ...
  render() {
    ...
    return (
      <Container>
        ...
        >
          <CustomHeader hasTabs navigation={navigation} title={"My Profile"}/>
          ...
          <View style={styles.profileInfoContainer}>
            ...
            <View style={styles.profileInfo}>
              <Text inverse style={styles.profileUser}>Jake Peralta</Text>
            ...
            <View style={styles.actions}>
              <View style={styles.action}>
                <Button style={styles.actionButton}>
                  <Icon style={styles.actionIcon} type={"FontAwesome"} name={"lock"}/>
                </Button>
                <Text style={styles.actionText}>Change Password</Text>
              </View>
              <View style={styles.action}>
                <Button style={styles.actionButton}>
                  <Icon style={styles.actionIcon} type={"FontAwesome"} name={"edit"}/>
                </Button>
                <Text style={styles.actionText}>Edit Details</Text>
              </View>
              <View style={styles.action}>
                <Button style={styles.actionButton}>
                  <Icon style={styles.actionIcon} type={"MaterialIcons"} name={"view-agenda"}/>
                </Button>
                <Text style={styles.actionText}>My Agenda</Text>
              </View>
            </View>
