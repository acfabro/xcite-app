...
module.exports = {
  ...
  // Button
  btnFontFamily:  "adineue PRO", //platform === "ios" ? "System" : "Roboto_medium",
...
//  brandSecondary: "#d9534f" +
  ...
  // Font
  fontFamily: "AdihausDIN", //platform === "ios" ? "System" : "Roboto",
  fontSizeBase: 15,
  ...
  toolbarInputColor: platform === "ios" ? "#eee" : "#fff",
  ...
  inverseTextColorHeavy: "#fff",
  noteFontSize: 14,

  // Title
  titleFontfamily: "adineue PRO", //platform === "ios" ? "System" : "Roboto_medium",
